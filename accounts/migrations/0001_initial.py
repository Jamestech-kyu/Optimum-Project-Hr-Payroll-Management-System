    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('ADMIN', 'Admin'), ('HR', 'HR'), ('MANAGER', 'Manager'), ('PAYROLL_OFFICER', 'Payroll Officer'), ('EMPLOYEE', 'Employee')], max_length=50, unique=True)),
